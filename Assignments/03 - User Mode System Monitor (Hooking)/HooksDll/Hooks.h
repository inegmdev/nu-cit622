...
/**
 * processthreadsapi.h -> CreateProcessAsUserA
 */
static BOOL (WINAPI* True_CreateProcessAsUserA) (
    HANDLE                hToken,
...
static BOOL WINAPI Hook_CreateProcessAsUserA(
    HANDLE                hToken,
    LPCSTR                lpApplicationName,
    LPSTR                 lpCommandLine,
    LPSECURITY_ATTRIBUTES lpProcessAttributes,
    ...
    return True_CreateProcessAsUserA(
        hToken, 
        lpApplicationName, 
        lpCommandLine, 
        lpProcessAttributes, 
 ...
 */
static HANDLE(WINAPI* True_FindFirstFileW) (
    LPCWSTR             lpFileName,
...
static HANDLE WINAPI Hook_FindFirstFileW(
    ...
    return True_FindFirstFileW(lpFileName, lpFindFileData);
}
/* ----------------------------------------- */
...
static LPWSTR  WINAPI Hook_GetCommandLineW(
    ...
    ClearLpstrFromLpwstr(commandLine);
    return commandLine;
}
/* ----------------------------------------- */
...
static DWORD WINAPI Hook_GetFullPathNameW(
    ...
    Log("{{"
        ...
        (GetLpcstrFromLpcwstr(lpFileName)) ? GetLpcstrFromLpcwstr(lpFileName) : "",
        nBufferLength,
        (GetLpstrFromLpwstr(lpBuffer)) ? GetLpstrFromLpwstr(lpBuffer) : ""
    );

    ClearLpcstrFromLpcwstr(lpFileName);
    ClearLpstrFromLpwstr(lpBuffer);
...
static void WINAPI Hook_GetStartupInfoW(
    ...
    Log("{{"
            ...
            "}}"
        "}}",
        (GetLpstrFromLpwstr(lpDesktop)) ? GetLpstrFromLpwstr(lpDesktop) : "",
        (GetLpstrFromLpwstr(lpTitle)) ? GetLpstrFromLpwstr(lpTitle) : "",
        lpStartupInfo->dwX,
        lpStartupInfo->dwY,
...
/**
 * winreg.h -> RegEnumKeyExA
 */
static LSTATUS (WINAPI* True_RegEnumKeyExA) (
    HKEY      hKey,
    DWORD     dwIndex,
    LPSTR     lpName,
    LPDWORD   lpcchName,
...
static LSTATUS WINAPI Hook_RegEnumKeyExA(
    HKEY      hKey,
    DWORD     dwIndex,
    LPSTR     lpName,
    LPDWORD   lpcchName,
...
/**
 * winreg.h -> RegEnumKeyExW
 */
static LSTATUS (WINAPI* True_RegEnumKeyExW) (
    HKEY      hKey,
    DWORD     dwIndex,
    LPWSTR    lpName,
    LPDWORD   lpcchName,
...
static LSTATUS WINAPI Hook_RegEnumKeyExW(
    HKEY      hKey,
    DWORD     dwIndex,
    LPWSTR    lpName,
    LPDWORD   lpcchName,
    ...
    Log("{{ "
        ...
        "}}",
        dwIndex,
        (GetLpstrFromLpwstr(lpName)) ? GetLpstrFromLpwstr(lpName) : "",
        *lpcchName,
        (GetLpstrFromLpwstr(lpClass))? GetLpstrFromLpwstr(lpClass) : "",
        *lpcchClass
    );

    ClearLpstrFromLpwstr(lpName);
    ClearLpstrFromLpwstr(lpClass);

    return True_RegEnumKeyExW(
        hKey,
        dwIndex,
        lpName,
        lpcchName,
...
/**
 * winreg.h -> RegEnumValueA
 */
static LSTATUS (WINAPI* True_RegEnumValueA) (
    HKEY    hKey,
    DWORD   dwIndex,
    LPSTR   lpValueName,
...
static LSTATUS WINAPI Hook_RegEnumValueA(
    HKEY    hKey,
    DWORD   dwIndex,
    LPSTR   lpValueName,
    LPDWORD lpcchValueName,
 ...
 */
static LSTATUS (WINAPI* True_RegEnumValueW) (
    HKEY    hKey,
    DWORD   dwIndex,
    LPWSTR  lpValueName,
    LPDWORD lpcchValueName,
...
static LSTATUS WINAPI Hook_RegEnumValueW(
    ...
    Log("{{ "
        ...
        "}}",
        dwIndex,
        (GetLpstrFromLpwstr(lpValueName)) ? GetLpstrFromLpwstr(lpValueName) : "",
        *lpcchValueName,
        *lpcbData
    );

    ClearLpstrFromLpwstr(lpValueName);

    return True_RegEnumValueW(
        hKey,
        dwIndex,
        lpValueName,
        lpcchValueName,
...
/**
 * winreg.h -> RegDeleteKeyW
 */
static LSTATUS(WINAPI* True_RegDeleteKeyW) (
    HKEY    hKey,
    LPCWSTR lpSubKey
    ) = RegDeleteKeyW;

static LSTATUS WINAPI Hook_RegDeleteKeyW(
    HKEY    hKey,
    LPCWSTR lpSubKey
) {
...
static HINSTANCE WINAPI Hook_ShellExecuteW(
    ...
    CreateLpcstrFromLpcwstr(lpOperation);
    CreateLpcstrFromLpcwstr(lpFile);
    ...
    Log("{{"
        ...
        (GetLpcstrFromLpcwstr(lpFile)) ? GetLpcstrFromLpcwstr(lpFile) : "",
        (GetLpcstrFromLpcwstr(lpParameters)) ? GetLpcstrFromLpcwstr(lpParameters) : "",
        (GetLpcstrFromLpcwstr(lpDirectory)) ? GetLpcstrFromLpcwstr(lpDirectory) : "",
        nShowCmd
    );

    ClearLpcstrFromLpcwstr(lpOperation);
    ClearLpcstrFromLpcwstr(lpFile);
    ClearLpcstrFromLpcwstr(lpParameters);
    ClearLpcstrFromLpcwstr(lpDirectory);
...
void DetourAttach_AllHooks() {
    ...
    /* winreg.h -> RegDeleteKeyW */
    HOOK_API(RegDeleteKeyW);
    /* winreg.h -> RegCloseKey */
    HOOK_API(RegCloseKey);
    /* winreg.h -> RegEnumKeyExA */
    HOOK_API(RegEnumKeyExA);
    /* winreg.h -> RegEnumValueA */
